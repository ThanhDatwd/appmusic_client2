...
const Album = () => {
    const { curentSongSt, curentAlbum, } = React.useContext(songContext)
                    ...
                    <Col xs={24} sm={24} md={7} lg={7} xl={7}>
                        <div className='playlist__info-area'>
                            ...
                            <div className="playlist__info">
                                ...
                                <span className='playlist__info-update'>Cập nhật : {moment(album.updatedAt).format('DD/MM/YYYY')}</span>
